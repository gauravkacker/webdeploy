...
export async function POST(
  request: NextRequest,
  { params }: { params: { patientId: string; billId: string } }
) {
  try {
    const { patientId, billId } = params;
    ...
    const validation = validator.validateBillDeletion(billId, patientId);
    ...
    console.error('Hard delete bill error:', errorMessage);
